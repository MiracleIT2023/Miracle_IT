...
const MainCource2 = () => {
  ...
  const cardData = [
    {
      imageSrc: require("../image/aws.webp"),
      altText: "Miracle Infoserv Image 1",
    },
    {
      imageSrc: require("../image/linex.png"),
      altText: "Miracle Infoserv Image 2",
    },
    {
      imageSrc: require("../image/hardware.jpg"),
      altText: "Miracle Infoserv Image 3",
    },
    {
      imageSrc: require("../image/network.jpg"),
      altText: "Miracle Infoserv Image 4",
    },
    {
      imageSrc: require("../image/IT-Security-Icon.jpg"),
      altText: "Miracle Infoserv Image 5",
    },
    {
      imageSrc: require("../image/Cisco.png"),
      altText: "Miracle Infoserv Image 6",
    },
    {
      imageSrc: require("../image/clou1.jpg"),
      altText: "Miracle Infoserv Image 7",
    },
  ];
  const cardData1 = [
    {
      imageSrc: require("../image/skill-1.png"),
      altText: "Miracle Infoserv Image 11",
      titel: "Quantitative Aptitude",
    },
    {
      imageSrc: require("../image/skill-2.png"),
      altText: "Miracle Infoserv Image 12",
      titel: "Logical Reasoning",
    },
    {
      imageSrc: require("../image/skill-3.png"),
      altText: "Miracle Infoserv Image 13",
      titel: "Articulateness",
    },
    {
      imageSrc: require("../image/skill-4.png"),
      altText: "Miracle Infoserv Image 14",
      titel: "Interview Training",
    },
    {
      imageSrc: require("../image/skill-5.png"),
      altText: "Miracle Infoserv Image 15",
      titel: "GD Training",
    },
    {
      imageSrc: require("../image/confidence-building-1.png"),
      altText: "Miracle Infoserv Image 16",
      titel: "Confidence building",
    },
    {
      imageSrc: require("../image/personality-development.png"),
      altText: "Miracle Infoserv Image 17",
    ...
    <>
      <div className="blogcontcource">
        <div className="row">
          ...
          >
            ...
            >
              {" "}
              Post Graduate Diploma In Infrastructure Engineering
            </h1>
            <p className="program11 animated-paragraph">
              {" "}
              Our Post Graduate Diploma program is designed to prepare you for
              high growth career path in Hardware, Networking, , Cloud Server and IT Security. You will be
              taken on a journey of end-to-end system creation and network
              development through a mix of theory, and extensive hands-on
              practice through labs.
              <br /> You will also have access to mentorship sessions, providing
              a high engagement learning experience and real world applications
              to help you master the essential Infrastruce Engineering skills in
              the IT Industry.
            </p>
        ...
        <div className="col-sm-4" style={{ margin: "auto" }}>
          ...
          <div className="col-sm-4 colsm4">
            <div className="cardp card-3">
              ...
              <p className="teqnicp">
                {" "}
                Gain knowledge in both, Hardware and Netwroking, CCNA Syllabus,
                Red Hat Linux Syllabus, IT Security, ITIL, Cloud Security and
          ...
          <div className="col-sm-4 colsm4">
            <div className="cardp card-2">
              ...
              <p className="teqnicp">
                {" "}
                Along with infusing networking skills we will work closely on your
            ...
            <div className="cardp card-4">
              ...
              <p className="teqnicp">
                {" "}
                Get hands-on experience with practical sessions with demo
                machines along with the learning the howabouts of building
        ...
        <div className="row ourcomesrow" style={{ padding: "50px" }}>
          ...
          >
            <h1 className="outcome1">
              Successful Post Graduate Diploma In Infrastructure Engineering.
            </h1>
            <h5 className="outcome2">
              Soon after completing this program, you will be a Infrastructure
              Engineer/ System Admin/ System Executive in a reputable IT Company
              with a very decent salary package as per the IT Industry
              standards.
            </h5>
        ...
        <div className="row ourcomesrow1" style={{ padding: "50px" }}>
          ...
          >
            ...
            <h5 className="outcome2">
              ...
              gain proficiency in handling multiple task.
            </h5>
            <h1 className="outcome1">Job positions</h1>
            <h5 className="outcome2">
              Server Admin, Linux Admin, Security Auditor, Desktop Engineer,
              Cloud Tech Expert, Server Administrator, Windows Security Engineer
              are some example of job positions.
            </h5>
            <h1 className="outcome1">Succeed in job interviews</h1>
            <h5 className="outcome2">
              Our program includes a soft skills development component that will
              enhance your abilities to succeed in job interviews and showcase
              your strengths in a better way.
            </h5>
          </div>
      ...
      <div className="intestrytrands" style={{ padding: "3%" }}>
          ...
          <div className="row myrow">
            <div className="col-sm-4 text-center ">
              ...
              <p className="card-text cardtextpp">
                For a Post Graduate Diploma In Infrastructure Engineering
                <br /> Annual Growth
              </p>
              <h1 style={{ color: "#ae424d" }}>10 Lakh</h1>
              <p className="card-text cardtextpp">
          ...
          <div className="col-sm-6 mycolm1" style={{ margin: "auto" }}>
            ...
            >
              <div className="accordion-item myaccordation">
                ...
                >
                  <div className="accordion-body mybody">
                    The practical sessions we will work on have real-world
                    scenarios. Also, to give you hands-on experience with every
              ...
              <div className="accordion-item myaccordation">
                ...
                >
                  <div className="accordion-body mybody">
                    The curriculum we have designed will give you a command of
                    the most useful tools and technologies which will make you a
                    job-ready after completion of the Post Graduate Diploma In
        ...
        <div className="row" style={{ marginTop: "50px" }}>
          ...
          <div className="col-sm-8 mycolm1">
            ...
            <p className="mycourcecontantp" style={{ marginLeft: "55px" }}>
              Our value-based system ensures your future success by providing
              proper placement training and guidance.
            </p>
            <div class="containermycou">
              <div
                class="black-boxmy"
        ...
        <div className="eligibility">
          <ul>
            <li className="lilist">
              To start with this Post Graduate Diploma In Infrastructure
            ...
            <li className="lilist">
              You must pass our basic admission test to enroll in this
              ...
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingOne">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    1. What is Post Graduate Diploma In Infrastructure
                    Engineering?
                  </button>
                </h2>
                <div
                ...
                >
                  <div className="accordion-body mybody">
                    Infrastructure Engineering stands for Hardware and
                    Networking Engineering, System Engineering, Network Creation
                    and Security and by using all these technologies together
                    you could build amazing System or Computer Network.
                  </div>
                </div>
              </div>
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingTwo">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    2. What is the salary of a Post Graduate Diploma In
                    Infrastructure Engineering?
                  </button>
                </h2>
                <div
                ...
                >
                  <div className="accordion-body mybody">
                    The average salary of a Post Graduate Diploma In
                    Infrastructure Engineering is around 9,00,000 and may go up
                    to 20,00,000 with 4-7 years of experience. .
                  </div>
                </div>
              </div>
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingThree">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    3. Which course is best suited to become a Post Graduate
              ...
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingFour">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    4. Is becoming a Post Graduate Diploma In Infrastructure
                ...
                >
                  <div className="accordion-body mybody ">
                    Yes, making a career in Post Graduate Diploma In
                    Infrastructure Engineering is worthwhile because companies
                    are desperately looking for developers who possess skills in
                    handling any situation and who can manage both, hardware and network related issue. In fact, companies are
                    offering a very decent job salary to System Admin roles.
                  </div>
                </div>
              </div>
              ...
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingFive">
                  ...
                  >
                    ...
                    Infrastructure Engineering without a degree?
                  </button>
                </h2>
                <div
                ...
                >
                  <div className="accordion-body mybody ">
                    ...
                    Infrastructure Engineering course
                    even if you are in your final year of graduation and don't
                    have the degree in your hands.
                  </div>
                </div>
              </div>
            </div>
