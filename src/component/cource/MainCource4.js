  ...
  return (
    <>
      <div className="blogcontcource">
        <div className="row">
          ...
          >
            ...
            >
              {" "}
              MEAN Stack Development by Miracle IT Career Academy!
            </h1>
            <p className="program11 animated-paragraph">
              {" "}
              With MongoDB, Express, Angular, and Node JS, our program offers thorough training in Full Stack MEAN development. In addition to technical skills training, we also provide education in the development of soft skills, logical thinking, personality, and expert interviews. Essential subjects including HTML, CSS, and JavaScript are covered in the program to ensure a solid foundation in web development.
          ...
          <div className="col-sm-6 colsm66" style={{ textAlign: "end", padding: "2%" }}>
            <img
              src={require("../image/PIC 10 (1).png")}
              style={{width:"90%"}}
              className="blogs1"
              alt="blogimg"
            />
        ...
        <div className="col-sm-4" style={{ margin: "auto" }}>
          ...
          <div className="col-sm-4 colsm4">
            <div className="cardp card-3">
              ...
              <p className="teqnicp">
                {" "}
                Gain expertise in the full-stack application that can be created using the MEAN stack development, which consists of four full-stack technologies.
      ...
      <div className=" mycontener space-around pt-5 pb-5 pl-2">
        ...
        >
          Outcomes of the MEAN Stack Development program?
        </div>
        <div className="row ourcomesrow" style={{ padding: "50px" }}>
          ...
          <div className="col-sm-8 mycolm1 colsm66" style={{ marginTop: "50px" }}>
            <h1 className="outcome1">Successful Full Stack MEAN Developer</h1>
            <h5 className="outcome2">
              Soon after completing this program, you will be a successful Full
              Stack MEAN Developer in a reputable IT Company with a very decent
        ...
        <div className="row ourcomesrow1" style={{ padding: "50px" }}>
          ...
          >
            ...
            <h1 className="outcome1">Job positions</h1>
            <h5 className="outcome2">
              Full stack engineer, full stack developer, MEAN Developer, Software engineer, and more.
            </h5>
            <h1 className="outcome1">Succeed in job interviews</h1>
            <h5 className="outcome2">
              Our program includes a soft skills development component that will
      ...
      >
              ...
              <div className="accordion-item myaccordation">
                ...
                >
                  <div className="accordion-body mybody">
                    ...
                    make you a job-ready as a Full Stack Developer.
                  </div>
                </div>
              </div>
              <div className="accordion-item myaccordation">
        ...
        <div className="eligibility">
          <ul>
            <li className="lilist">
              To start with this full stack developer course you must have a basic knowledge and
          ...
          <div className="col-sm-12" style={{ margin: "auto" }}>
            ...
            >
              <div className="accordion-item myaccordation">
                ...
                >
                  <div className="accordion-body mybody">
                    MEAN stands for MongoDB, Express Js, Angular Js, and Node
                    Js, and by using all these technologies together you could
              ...
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingTwo">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    2. What is the Full Stack Developer Salary?
                  </button>
                </h2>
                <div
                  id="flush-collapseTwo"
                ...
                >
                  <div className="accordion-body mybody">
                    The average salary of a Full Stack Developer is around
                    8,00,000 and may go up to 15,00,000 with 4-7 years of
                    experience.
                  </div>
                </div>
              </div>
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingThree">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    3. Which course is best suited to become a Full Stack MEAN
                    Developer?
                  </button>
                </h2>
                <div
              ...
              <div className="accordion-item myaccordation">
                <h2 className="accordion-header" id="flush-headingFour">
                  <button
                    ...
                    style={{ borderRadius: "19px" }}
                  >
                    4. Is becoming a Full Stack Developer a good career
                    option?
                  </button>
                </h2>
                <div
                ...
                >
                  <div className="accordion-body mybody ">
                    Yes, making a career in Full Stack Development is
                    worthwhile because companies are desperately looking for
                    developers who possess skills in handling any situation and
                    who can manage both, front-end as well as back-end
                    development. In fact, companies are offering a very decent
                    job salary to Full Stack Developers.
                  </div>
                </div>
              </div>
            ...
            <div className="accordion-item myaccordation">
              <h2 className="accordion-header" id="flush-headingFive">
                <button
                  ...
                  style={{ borderRadius: "19px" }}
                >
                  5. Is it possible to become a MEAN Stack Developer
                  without a degree?
                </button>
              </h2>
              <div
              ...
              >
                <div className="accordion-body mybody ">
                  ...
                  Full Stack MEAN development even if you are in your
                  final year of graduation and don't have the degree in your
                  hands.
                </div>
                </div>
              </div>
